...
//        listaProdutos.add(new Produto("Notebook Lenovo", 0.498, 1999.90));
        ...
        Double probabilidadeDeMutacao = 0.01;
        ...
        for (int i = 0; i < ag.getPopulacao().size() / 2; i++) {
            ...
            novaPopulacao.add(filhos.get(0).mutacao(probabilidadeDeMutacao));
            novaPopulacao.add(filhos.get(1).mutacao(probabilidadeDeMutacao));
        }
        ...
        System.out.println("Melhor: " + melhorSolucao.getCromossomo()
